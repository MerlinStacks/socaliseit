...
- Name: auth.spec.ts >> Authentication >> should navigate to registration page
- Location: e2e/auth.spec.ts:51:4
...
Call log:
  - waiting for getByRole('link', { name: /register|sign up|create account/i })
