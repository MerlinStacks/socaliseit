...
- Name: auth.spec.ts >> Protected Routes >> should redirect unauthenticated users from settings
- Location: e2e/auth.spec.ts:109:4
...
Call log:
  - Expect "to.have.url" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/settings"
