...
- Name: auth.spec.ts >> Protected Routes >> should redirect unauthenticated users from compose
- Location: e2e/auth.spec.ts:104:4
...
Received string:  "http://localhost:3000/compose"
Timeout: 5000ms

Call log:
  - Expect "to.have.url" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/compose"
