...
const FEATURES = [
    {
        ...
        description: 'Publish to Instagram, TikTok, YouTube, Facebook, Pinterest, LinkedIn, Bluesky, and Google Business from a single unified composer.',
    },
    {
        icon: (
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-7 w-7">
        ...
        <div className="min-h-screen bg-[var(--bg-primary)]">
            ...
            <nav className="sticky top-0 z-30 glass border-b border-[var(--border)]">
                <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/login">
                            <Button variant="secondary" className="btn-interactive">
                                Sign In
                            </Button>
                        </Link>
                        <Link href="/register">
            ...
            <section className="relative overflow-hidden px-6 pb-20 pt-24 md:pt-32">
                ...
                <div className="relative mx-auto max-w-4xl text-center">
                    ...
                    <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                        ...
                        <Link href="/login">
                            <Button variant="secondary" className="btn-interactive h-12 px-8 text-base">
                                Sign In
                            </Button>
                        </Link>
                    </div>
                ...
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {FEATURES.map((feature) => (
                            ...
                            >
                                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient text-white">
                                    {feature.icon}
                                </div>
