...
- Name: auth.spec.ts >> Authentication >> should have Google OAuth button
- Location: e2e/auth.spec.ts:86:4
...
Locator: getByRole('button', { name: /google|continue with google/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /google|continue with google/i })
