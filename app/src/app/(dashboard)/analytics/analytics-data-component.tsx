/**
 * Analytics data-fetching server component
 * Why: Extracted from page.tsx so it can be wrapped in <Suspense>.
 * This lets the page respond instantly during navigation while
 * the 8+ parallel DB queries stream in.
 */
 ...
 * Rendered inside <Suspense> so the loading skeleton shows instantly.
 */
export async function AnalyticsDataComponent({
    organizationId,
    platformFilter,
    range,
}: AnalyticsDataComponentProps) {
    /**
